...
import React, { useEffect, useState } from "react";
import { Box, Button, Card, CardContent, Typography, Dialog, Grid, CardActions } from "@mui/material";
import AddIcon from "@mui/icons-material/Add";
import EditIcon from "@mui/icons-material/Edit";
import { addDoc, updateDoc, getDocs, collection, doc, getFirestore } from "firebase/firestore"; // fixed import
import AddSubjectDialog from "../components/AddSubjectDialog";
...
const TeacherDashboard = () => {
  ...
  const handleAddOrEditSubject = async (newSubject: any) => {
    let updatedSubjects;
    if (editIndex !== null) {
      const subjectRef = doc(db, "subjects", subjects[editIndex].id);
      await updateDoc(subjectRef, newSubject);

      updatedSubjects = [...subjects];
      updatedSubjects[editIndex] = { ...newSubject, id: subjects[editIndex].id }; // keep ID
    } else {
      const docRef = await addDoc(collection(db, "subjects"), newSubject);
      updatedSubjects = [...subjects, { ...newSubject, id: docRef.id }];
    }
